...
public class GraphQlGenerationTests
{
    private readonly PrintGenerator generator = new();
    private readonly ManifestValidator validator = new();

    [Fact]
    public async Task GenerateAsync_GraphQLGeneratesNonEmptyZipWithManifest()
    {
    ...
    [Fact]
    public async Task GenerateAsync_GraphQLZipContainsExpectedFiles()
    {
        var manifest = new ForgeManifest
        {
            Product = "clarivolt",
    ...
    [Fact]
    public void Validate_RejectsGraphQLNameNotEndingWithService()
    {
        var manifest = new ForgeManifest
        {
            Product = "clarivolt",
        ...
        result.Errors.Should().Contain(error => error.Contains("GraphQL") && error.Contains("-service"));
    }

    [Fact]
    public void Validate_AcceptsValidGraphQLNameEndingWithService()
    {
        var manifest = new ForgeManifest
        {
            Product = "clarivolt",
